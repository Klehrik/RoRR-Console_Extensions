Console.new{
    "buff_apply (buff) (duration) [count] [m_id]",
    {
        ...
        {"[count]",     "bool",   "The number of stacks to apply. <y>1</c> by default."},
    ...
    function(args)
        ...
        if type(duration) ~= "number" then
            Console.print("Invalid buff duration.")
            return
        end
        ...
        p:buff_apply(buff, duration, count or 1)
    end
}